            ...
            <div class="card shadow border-primary">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('laporan-konfir') }}" class="btn btn-primary btn-sm float-right"><i class="fas fa-fw fa-solid fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="row mb-2 align-items-center">
                                ...
                                <div class="col-md-8">
                                    <input type="text" id="created_at" class="form-control form-control-sm text-dark" name="created_at" value="{{ \Carbon\Carbon::parse($pengumpulans->skripsis->created_at)->format('d F Y') }}" readonly>
                                </div>
                            </div>
                            <div class="row mb-2 align-items-center">
                                <div class="col-md-4">
